...
hetu_diagnostic(diagnosis_example, extract = c("invalid.century", "incorrect.checksum"))
```
...
hetu_diagnostic(diagnosis_example, subsetting = TRUE, extract = "invalid.century")
```
