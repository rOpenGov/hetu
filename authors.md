...
- **Pyry Kantanen**. Author, maintainer.
  [](https://orcid.org/0000-0003-2853-2765)

- **Mans Magnusson**. Author.

- **Jussi Paananen**. Author.

- **Juho Kopra**. Contributor.

- **Oskari Luomala**. Contributor.

- **Tuomo Nieminen**. Contributor.
...
Source:
[`inst/CITATION`](https://github.com/rOpenGov/hetu/blob/main/inst/CITATION)
...
hetu: Structural Handling of Finnish Personal Identity Codes \[Computer
software\]. R package version 1.2.0. DOI:
